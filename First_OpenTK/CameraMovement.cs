...
namespace First_OpenTK
{
    class CameraMovement
    {
        ...
        {
            eye = new Vector3(10, 10, 30);
            target = new Vector3(0, 0, 0);
            up_vector = new Vector3(0, 1, 0);
        }

        public CameraMovement(int _eyeX, int _eyeY, int _eyeZ, int _targetX, int _targetY, int _targetZ, int _upX, int _upY, int _upZ)
        {
        ...
        public CameraMovement(Vector3 _eye, Vector3 _target, Vector3 _up)
        {
            eye = _eye;
            target = _target;
            up_vector = _up;
