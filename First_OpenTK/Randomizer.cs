...
namespace First_OpenTK
{
    ...
    class Randomizer
    {
        ...
        /// </summary>
        /// <returns>random int;</returns>
        public int RandomInt(int GIVEN_VALUE)
        {
            int i = r.Next(0, GIVEN_VALUE);

            return i;
        }

        /// <summary>
        /// This method returns a random int when required. The value is ranged between given range
        /// </summary>
        /// <returns>random int;</returns>
        public int RandomInt(int min_VALUE, int max_VALUE)
        {
            int i = r.Next(min_VALUE, max_VALUE);
